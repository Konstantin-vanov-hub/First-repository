...
result_label_summa = tk.Label(root, text='Value:',font=default_font_bold)
result_label_summa.pack()

entry = tk.Entry(root, width=30, font=default_font_bold)
entry.pack(pady=(10, 5))

result_label_from = tk.Label(root, text='From:',font=default_font_bold)
result_label_from.pack()

combobox1 = ttk.Combobox(values=currensy, width=28, font=default_font_bold)
combobox1.pack(pady=5)

result_label_to = tk.Label(root, text='To:',font=default_font_bold)
result_label_to.pack()

combobox2 = ttk.Combobox(values=currensy, width=28, font=default_font_bold)
...
result_output = tk.Label(root, text='',font=('Arial', 15))
result_output.pack()
